...
ex1.onclick = function () {
    ...
    lista.style.top = '-580px'
    pdf.src = 'precisao2.pdf'
    video1.src = 'exPrecisao2.mp4'
    pdf.style.zIndex = '50'
...
ex2.onclick = function () {
    ...
    base.style.display = 'none'
    criaShape(3, 5, 6, 3, 5, 6, 4, 5, 7, 3, 5, 7, 4, 7, 8, 5, 6, 8)
    criaShape(8, 10, 11, 9, 10, 12, 8, 10, 12, 8, 11, 12, 10, 11, 13, 10, 11, 14)
    criaShape(10, 11, 14, 10, 12, 13, 10, 12, 13, 11, 12, 14, 11, 13, 15, 11, 14, 15)
    criaShape(2, 3, 5, 1, 3, 5, 1, 4, 5, 2, 3, 5, 3, 4, 7, 3, 5, 6)
...
ex3.onclick = function () {
    ...
    gm.onclick = function () {
        ...
        for (i = 0; i < nota.length; i++) {
            ...
            if (nota[i].innerHTML == 'G' || nota[i].innerHTML == 'Bb' || nota[i].innerHTML == 'A#' || nota[i].innerHTML == 'D') {
    ...
    aDim.onclick = function () {
        ...
        for (i = 0; i < nota.length; i++) {
            ...
            if (nota[i].innerHTML == 'A' || nota[i].innerHTML == 'C' || nota[i].innerHTML == 'Eb') {
    ...
    bb.onclick = function () {
        ...
        for (i = 0; i < nota.length; i++) {
            ...
            if (nota[i].innerHTML == 'Bb' || nota[i].innerHTML == 'D' || nota[i].innerHTML == 'F#') {
    ...
    cm.onclick = function () {
        ...
        for (i = 0; i < nota.length; i++) {
            ...
            if (nota[i].innerHTML == 'C' || nota[i].innerHTML == 'Eb' || nota[i].innerHTML == 'G') {
    ...
    d.onclick = function () {
        ...
        for (i = 0; i < nota.length; i++) {
            ...
            if (nota[i].innerHTML == 'D' || nota[i].innerHTML == 'F#' || nota[i].innerHTML == 'A') {
    ...
    eb.onclick = function () {
        ...
        for (i = 0; i < nota.length; i++) {
            ...
            if (nota[i].innerHTML == 'Eb' || nota[i].innerHTML == 'G' || nota[i].innerHTML == 'Bb') {
    ...
    fsDim.onclick = function () {
        ...
        for (i = 0; i < nota.length; i++) {
            ...
            if (nota[i].innerHTML == 'F#' || nota[i].innerHTML == 'A' || nota[i].innerHTML == 'C') {
...
ex4.onclick = function () {
    ...
    gm.onclick = function () {
        ...
        for (i = 0; i < nota.length; i++) {
            ...
            if (nota[i].innerHTML == 'G' || nota[i].innerHTML == 'Bb' || nota[i].innerHTML == 'A#' || nota[i].innerHTML == 'D' || nota[i].innerHTML == 'F#') {
    ...
    aDim.onclick = function () {
        ...
        for (i = 0; i < nota.length; i++) {
            ...
            if (nota[i].innerHTML == 'A' || nota[i].innerHTML == 'C' || nota[i].innerHTML == 'Eb' || nota[i].innerHTML == 'G') {
    ...
    bb.onclick = function () {
        ...
        for (i = 0; i < nota.length; i++) {
            ...
            if (nota[i].innerHTML == 'Bb' || nota[i].innerHTML == 'D' || nota[i].innerHTML == 'F#' || nota[i].innerHTML == 'A') {
    ...
    cm.onclick = function () {
        ...
        for (i = 0; i < nota.length; i++) {
            ...
            if (nota[i].innerHTML == 'C' || nota[i].innerHTML == 'Eb' || nota[i].innerHTML == 'G' || nota[i].innerHTML == 'Bb') {
    ...
    d.onclick = function () {
        ...
        for (i = 0; i < nota.length; i++) {
            ...
            if (nota[i].innerHTML == 'D' || nota[i].innerHTML == 'F#' || nota[i].innerHTML == 'A' || nota[i].innerHTML == 'C') {
    ...
    eb.onclick = function () {
        ...
        for (i = 0; i < nota.length; i++) {
            ...
            if (nota[i].innerHTML == 'Eb' || nota[i].innerHTML == 'G' || nota[i].innerHTML == 'Bb' || nota[i].innerHTML == 'D') {
    ...
    fsDim.onclick = function () {
        ...
        for (i = 0; i < nota.length; i++) {
            ...
            if (nota[i].innerHTML == 'F#' || nota[i].innerHTML == 'A' || nota[i].innerHTML == 'C' || nota[i].innerHTML == 'Eb') {
...
botao0.onclick = function () {
    ...
    if (posicao.value == 1) {
        ...
        apagar()
        criaShape(5, 6, 8, 5, 6, 9, 5, 7, 8, 5, 7, 8, 7, 8, 10, 6, 8, 10)
        ...
        apagar()
        criaShape(6, 8, 10, 6, 9, 10, 7, 8, 10, 7, 8, 11, 8, 10, 11, 8, 10, 11)
